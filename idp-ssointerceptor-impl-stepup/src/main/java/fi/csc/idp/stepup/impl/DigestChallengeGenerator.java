...
public class DigestChallengeGenerator implements ChallengeGenerator {
	...
	/** Class logger. */
    @Nonnull private final Logger log = LoggerFactory.getLogger(DigestChallengeGenerator.class);
    
    /** The salt for digest. */
    @Nullable private String salt="replaceme";
    
    /** The max length for Challenge */
    @Nullable private int maxLength=8;
    
    /** The digest. */
    @Nullable private String digest="SHA-256";
    
    /**
     * Set the salt.
     * 
     * @param newSalt to replace default one. 
     */
    ...
    /**
     * Set the maximum length for challenge. If smaller than four, has no effect.
     * 
     * @param newMaxLength to replace default one. 
     */
     ...
     * 
     * @param newDigest to replace default one. 
     */
